...
export default function PreviewCard({category, header, description, price, discountedPrice}: Props) {
    return <div className={styles.main}>
        ...
        <div className={styles.info}>
            ...
            <button className={`${styles.cartButton} ${montserrat2.className}`}><Image src="/icon-cart.svg" alt="Shopping cart image" width={14} height={16} loading="lazy" className={styles.btnImage} />Add to cart</button>
        </div>
    </div>
}